...
export default class LevelComplete{
     ...
     */
    constructor(scene, nextLevel, customMessage){
        ...
        this.message = new TextButton(scene, 600, 200, -1, -1, -1, 0x2FC325, 1, 100, 'GBD_b', (customMessage === undefined ? "Level Complete" : customMessage));
        this.message.align();

        // next level button 
        this.button = new TextButton(scene, 600, 660, 400, 400, 80, 0x00, 1, 40, 'GBD_w', 'NEXT LEVEL');
        this.button.align();
