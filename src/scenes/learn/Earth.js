...
export default class EarthLevel extends Phaser.Scene{
    constructor(){
        super({key: 'EarthLevel'});
    }

    // this is learning level 1. 
    preload(){
        // get screen bounds 
    ...
    create(){
        ...
        let notes = new Notebook(this, [this.width, this.height], ['Earth']);
        notes.enable();

        // display planet info 
        new InfoScreen(this, 'Earth');
    }
